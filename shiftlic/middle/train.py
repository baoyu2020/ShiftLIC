...
class ScaleHyperpriorsAutoEncoder(CompressionModel):
    ...
    def __init__(self, N, M, **kwargs):
        ...
        self.encoder = nn.Sequential(
            ...
            ResidualBlockShift(128, 128),
            ResidualBlockShift(128, 128),
            # CheapCS1(128,128),    # 每个ResidualBlockShift的位置
            nn.PixelUnshuffle(2),
...
def parse_args(argv):
    ...
    parser.add_argument('--out_dir',type=str,default='./Log/stage_perf/Q6',help='path of log and saved models')
